@extends('layouts.app')
@section('title', 'Laporan Transaksi Travel')
@section('heading', 'Laporan Transaksi Travel')
@section('page', 'Laporan Transaksi Travel')
@section('content')
    <section class="section">
        <div class="card">
            <div class="card-header">
                <form action="{{ route('cetak-laporan.travel') }}" method="POST">
                    @csrf
                    <div class="col-sm-3">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $ndata)
                            ...
                            <td>{{ $ndata->getOrderFromTransaksi->getProdukFromOrder->getTravelFromProduk->nama_paket }}
                            </td>
                            <td>

@extends('layouts.app')
@section('title', 'Tambah Data Travel')
@section('heading', 'Tambah Data Travel')
@section('page', 'Tambah Data Travel')
@section('detailpage', '')
@section('content')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal"
                                id="tanggal" placeholder="Tanggal Travel" value="{{ old('tanggal') }}" autofocus>
                            @error('tanggal')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="time" class="form-control @error('waktu') is-invalid @enderror" name="waktu"
                                id="waktu" placeholder="Waktu Travel" value="{{ old('waktu') }}" autofocus>
                            @error('waktu')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>

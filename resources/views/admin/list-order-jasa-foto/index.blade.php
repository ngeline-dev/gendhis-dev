@extends('layouts.app')
@section('title', 'Data Order Jasa Foto')
@section('heading', 'Data Order Jasa Foto')
@section('page', 'Data Order Jasa Foto')
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('list-order-create.foto') }}" class="btn btn-primary">Tambah Pemesanan</a>
